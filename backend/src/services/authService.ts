...
export const authService = {
  ...
  /**
   * ลืมรหัสผ่าน - ขอรหัสตั้งรหัสผ่านใหม่
   *
   * *** ต้องเป็นอีเมลที่สมัครไว้ในระบบเท่านั้น ***
   * ถ้ากรอกอีเมลที่ไม่มีอยู่จริง ระบบจะปฏิเสธและบอกไปตรง ๆ
   * ไม่ปล่อยให้เดินต่อไปหน้าตั้งรหัสผ่านใหม่ เพราะไม่มีบัญชีให้เปลี่ยนตั้งแต่แรก
   *
   * *** ข้อแลกเปลี่ยนที่เลือกไว้อย่างตั้งใจ ***
   * ตำราความปลอดภัยแนะนำให้ตอบเหมือนกันทุกกรณี เพื่อไม่ให้ใครเอาหน้านี้
   * ไปไล่เช็คว่าอีเมลไหนเป็นสมาชิกบ้าง แต่ผลคือผู้ใช้ที่พิมพ์อีเมลผิด
   * จะเดินต่อไปจนสุดทางแล้วล้มเหลวโดยไม่รู้สาเหตุ ซึ่งสับสนกว่ามาก
   *
   * โครงงานนี้เลือกฝั่ง "บอกให้ชัด" เพราะเป็นระบบสำหรับสาธิตและตรวจงาน
   * ความเข้าใจง่ายของผู้ใช้สำคัญกว่าการปิดบังรายชื่อสมาชิก
   * ถ้าวันหนึ่งเปิดใช้จริงกับคนหมู่มาก ค่อยกลับมาทบทวนข้อนี้อีกครั้ง
   */
  async forgotPassword({ email }: ForgotPasswordRequest): Promise<ForgotPasswordResult> {
    /*
     * demoMode = เซิร์ฟเวอร์ยังไม่ได้ผูกบัญชีส่งอีเมล
     * ใช้บอกฝั่งแอปว่าจะซ่อนช่องกรอกรหัสหรือไม่ ไม่เกี่ยวกับตัวผู้ใช้
     */
    ...
    if (!user) {
      throw ApiError.notFound(
        'ไม่พบอีเมลนี้ในระบบ กรุณาตรวจสอบอีกครั้ง หรือสมัครสมาชิกก่อน'
      );
    }

    /*
     * บัญชีที่ถูกระงับแยกข้อความออกมา เพราะอีเมลมีอยู่จริงแต่ใช้ไม่ได้
     * ถ้าบอกว่า "ไม่พบอีเมล" เจ้าของบัญชีจะนึกว่าตัวเองจำอีเมลผิด
     * แล้วไปสมัครใหม่ซ้ำ ทั้งที่ปัญหาจริงคือต้องติดต่อผู้ดูแล
     */
    if (!user.is_active) {
