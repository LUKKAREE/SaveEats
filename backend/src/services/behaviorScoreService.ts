 ...
 *   - ได้รีวิว 1-2 ดาว                    -2
 *   - ถูกแจ้งปัญหาและผู้ดูแลตัดสินว่าผิด  -8
...
export const RULES = {
  ...
  BAD_REVIEW: -2,
  /*
   * ผู้ดูแลตรวจเรื่องร้องเรียนแล้วตัดสินว่าร้านผิดจริง
   * หนักกว่ารีวิวแย่ เพราะผ่านการตรวจสอบจากคนกลางมาแล้ว
   * แต่เบากว่าการที่ลูกค้ามาถึงแล้วไม่มีของ ซึ่งเสียหายกับลูกค้าโดยตรง
   */
  CONFIRMED_REPORT: -8,
  COMPLETED_PICKUP: 1,
  GREAT_REVIEW: 1,
