 ...
 * ==========================================================
 *
 * มี 2 โหมด สลับด้วยการแก้ค่า MODE บรรทัดเดียวข้างล่าง
 *
 *   'cloud'  ใช้ Backend ที่ขึ้นออนไลน์แล้ว
 *            มือถือใช้เน็ตมือถือได้เลย ไม่ต้องต่อ Wi-Fi วงเดียวกับคอม
 *            ไม่ต้องเปิดคอมของทีมเลย  <-- โหมดที่ใช้ตอนส่งงานและตอนให้คนอื่นทดสอบ
 *
 *   'lan'    ใช้ Backend ที่รันบนคอมตัวเอง
 *            มือถือกับคอมต้องต่อ Wi-Fi วงเดียวกัน และต้องแก้เลข IP ทุกครั้งที่ย้ายที่
 *            ใช้ตอนพัฒนา เพราะแก้โค้ดแล้วเห็นผลทันทีไม่ต้องรอ deploy
 *
 * ------------------------------------------------------------------
 * วิธีหาเลข IP สำหรับโหมด 'lan'
 ...
 *
 * เช็คว่าใช้ได้ไหม: เปิดเบราว์เซอร์บนมือถือ พิมพ์ที่อยู่ตามด้วย /api/health
...
export const BASE_URL: string = MODE === 'cloud' ? CLOUD_URL : `http://${DEV_HOST}:${DEV_PORT}`;
