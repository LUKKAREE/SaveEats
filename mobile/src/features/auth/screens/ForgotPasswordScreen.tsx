 ...
 *
 * *** หน้านี้แสดงผลว่า "ส่งแล้ว" เหมือนกันทุกกรณี ***
 * ไม่ว่าอีเมลที่กรอกจะมีในระบบหรือไม่ ตาม backend ที่ตั้งใจตอบเหมือนกัน
 * เพื่อไม่ให้ใครเอาหน้านี้ไปไล่เช็คว่าใครเป็นสมาชิกของเราบ้าง
 */
