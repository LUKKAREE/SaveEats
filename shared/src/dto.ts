...
export interface ForgotPasswordResult {
  ...
  /**
   * เซิร์ฟเวอร์ยังไม่ได้ผูกบัญชีส่งอีเมลหรือไม่
   *
   * *** ทำไมต้องมีค่านี้แยกจาก demoCode ***
   * demoCode เป็น null ได้จาก 2 สาเหตุที่ต่างกันสิ้นเชิง
   *   1. ตั้งค่า SMTP แล้ว รหัสจึงเดินทางไปทางอีเมลอย่างเดียว
   *   2. อีเมลที่กรอกมาไม่มีอยู่ในระบบ จึงไม่มีรหัสให้ตั้งแต่แรก
   *
   * ถ้าฝั่งแอปเอา demoCode ไปตัดสินว่าจะวาดหน้าจอแบบไหน
   * หน้าจอจะต่างกันระหว่าง "อีเมลมีจริง" กับ "อีเมลไม่มี"
   * ซึ่งเท่ากับบอกใบ้ว่าใครเป็นสมาชิกของระบบบ้าง
   *
   * ค่านี้จึงคำนวณจากการตั้งค่า SMTP เท่านั้น ไม่เกี่ยวกับอีเมลที่กรอกมา
   * ทำให้หน้าจอเหมือนกันทุกกรณี ไม่ว่าอีเมลนั้นจะมีอยู่จริงหรือไม่
   */
  demoMode: boolean;
}
