...
--
--  รหัสผ่าน : 123456   (เป็นค่า hash จาก bcrypt ไม่ได้เก็บรหัสจริง)
--
--  *** ทำไม admin ยังใช้ 123456 ได้ ทั้งที่กฎใหม่บังคับ 8 ตัว ***
--  เพราะกฎความแข็งแรงบังคับตอน "ตั้งรหัสใหม่" เท่านั้น ไม่บังคับตอน login
--  ถ้าบังคับตอน login ด้วย คนที่สมัครไว้ก่อนเปลี่ยนกฎจะเข้าบัญชีตัวเองไม่ได้เลย
--
...
INSERT INTO users (user_id, name, email, phone, password, role) VALUES
  (1, 'ผู้ดูแลระบบ', 'admin@saveeats.com', '0800000000',
   '$2b$10$6ZdaXUnw2VPFzUfbYViAG.6glJmJAF.5G.ds6AfaDUPkDFF0mJhay', 'admin')
...
--  2. เว็บแอดมิน : login admin@saveeats.com / 123456
